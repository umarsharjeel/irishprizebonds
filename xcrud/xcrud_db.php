        ...
        if (!isset(self::$_instance[$instance_name]) or null === self::$_instance[$instance_name])
        {
            if (!is_array($params))
            {
               ...
               $dbhost = Xcrud_config::$dbhost;
                ...
                //include(dirname(__FILE__)."/../antelope_config.php");
                //include(dirname(__FILE__)."/../application/config/config.php");



                // $dbuser = $antelope_config['db_user'];//Xcrud_config::$dbuser;
                // $dbpass = $antelope_config['db_pass'];//Xcrud_config::$dbpass;
                // $dbname = $antelope_config['db_name'];//Xcrud_config::$dbname;
                // $dbhost = $antelope_config['db_host'];//Xcrud_config::$dbhost;
