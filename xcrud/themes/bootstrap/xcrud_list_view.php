...
<?php if ($this->is_create or $this->is_csv or $this->is_print){?>
        <div class="xcrud-top-actions">
            <div class="btn-group pull-right">
                <?php echo $this->print_button('waves-effect btn btn-default','glyphicon glyphicon-print');
                echo $this->csv_button('waves-effect btn btn-default','glyphicon glyphicon-file'); ?>
            </div>
            <?php echo $this->add_button('waves-effect waves-lightx btn btn-primary','glyphicon glyphicon-plus-sign'); ?>
