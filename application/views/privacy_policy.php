...
<div class="container">
	<div class="content-page-body">
		...
		<ul>
			...
			<li><strong>Analytics</strong> — we use Google Analytics (GA4) to understand how the site is used. See "Cookies" below.</li>
			<li><strong>Advertising</strong> — we display ads through Google AdSense. Google and its partners may set cookies to serve and measure ads.</li>
		</ul>
		<p>
		...
		<ul>
			...
			<li><strong>Analytics</strong> — set by Google Analytics (GA4) to measure aggregate site usage.</li>
			<li><strong>Advertising</strong> — set by Google AdSense and its partners to serve and measure ads.</li>
		</ul>
		<p>
			You can block or delete cookies at any time through your browser settings, or opt out of Google Analytics
			specifically using Google's <a href="https://tools.google.com/dlpage/gaoptout" target="_blank" rel="noopener">Analytics opt-out browser add-on</a>.
		</p>
		...
		<ul>
			...
			<li>To understand and improve site usage, and to fund the site through advertising.</li>
		</ul>
		...
		<p>
			You can object to any cookie at any time by blocking or clearing it through your browser settings.
			For Google Analytics specifically, Google also offers an <a href="https://tools.google.com/dlpage/gaoptout" target="_blank" rel="noopener">Analytics opt-out browser add-on</a>;
			for ad personalisation, see Google's own <a href="https://myadcenter.google.com" target="_blank" rel="noopener">Ad Center</a> controls.
		</p>
